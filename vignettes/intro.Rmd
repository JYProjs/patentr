...
author: "Raoul R. Wadhwa, James Yu, Milind Y. Desai, Jacob G. Scott, Péter Érdi"
date: "30 May 2021"
...
Although files are available for patents issued during or after 1976, patents from different periods are accessible in different formats: patents issued between 1976 and 2001 (inclusive) are provided in TXT files; patents issued between 2002 and 2004 (inclusive) are provided in XML format; and patents issued during or after 2005 are provided in a distinct XML format.
...
For this, we use `read_csv` from the `readr` package.
...
More information about these can be found at https://uspto.gov.
...
For official definitions, visit https://uspto.gov.
